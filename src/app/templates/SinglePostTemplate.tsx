...
import { SeparatorPattern } from "@/app/patterns/SeparatorPattern";
import { researchPosts, shopItems } from "@/app/post-types";
import { ArrowLeft } from "lucide-react";
import { SingleProductTemplate } from "@/app/templates/SingleProductTemplate";
import { BlogPostPattern } from "@/app/templates/BlogPostPattern";
...
export default function SinglePostTemplate() {
  ...
  if (isProduct && product) {
    ...
    return <SingleProductTemplate product={product} relatedProducts={related} />;
  }

  if (!isProduct && post) {
    return <BlogPostPattern post={post} allPosts={researchPosts} />;
  }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <SeparatorPattern backgroundClass="bg-white" topEdge={true} bottomEdge={false} className="-mt-10 pt-16 relative z-10">
