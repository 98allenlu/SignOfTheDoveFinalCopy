...
import { shopItems, researchPosts } from "@/app/post-types";
import { ArrowRight } from "lucide-react";
import { motion } from "motion/react";
import Vector from "@/imports/SvgIconBlock";
...
export default function FrontPageTemplate() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Featured Research */}
      <SeparatorPattern backgroundClass="bg-[#FCFBF1]" className="py-20 md:py-32">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="font-headline text-4xl md:text-5xl text-primary mb-2">Recent Research</h2>
              <p className="font-body text-black text-lg">Exploring history through color and cloth.</p>
            </div>
