...
import { useCart } from "@/app/context/WooCartContext";
...
export function SingleProductTemplate({ product, relatedProducts = [] }: ProductPageProps) {
  ...
  function handleAddToCart() {
    addItem({ id: product.id, title: product.title, price: product.price, image: product.featured_image, slug: product.slug }, quantity);
    setAdded(true);
